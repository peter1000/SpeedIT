...
def main():
   ...
   setup_line_list = [
      'from __main__ import example_tuple1a, example_tuple1b, example_tuple2a, example_tuple2b'
   ]

   check_run_sec = 1
   with open('result_output/Example25IsInstanceVsLenTuple.txt', 'w') as file_:
      file_.write('\n\n Example25IsInstanceVsLenTuple.py output\n\n')
