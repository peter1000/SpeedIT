...
def txt_split_line_end():
   for line in (act_one_hamlet.split('\n')):
      pass


def txt_splitlines():
   for line in (act_one_hamlet.splitlines()):
      pass


def txt_string_io_for_line_in_file():
   for line in StringIO(act_one_hamlet):
      pass
...
def main():
   ...
   func_dict = {
      ...
      'txt_split_line_end': (txt_split_line_end, [], {}),
      'txt_splitlines': (txt_splitlines, [], {}),
      'txt_string_io_for_line_in_file': (txt_string_io_for_line_in_file, [], {}),
   ...
   setup_line_list = [
      'from io import StringIO',
      'from __main__ import act_one_hamlet',
   ]

   check_run_sec = 1
   with open('result_output/Example9LoopOverTextbyLines.txt', 'w') as file_:
      file_.write('\n\n Example9LoopOverTextbyLines.py output\n\n')
