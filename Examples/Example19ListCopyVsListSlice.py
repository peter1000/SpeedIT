...
def example_list_copy():
   final_list = test_list1.copy()


def example_list_copy_copy():
   final_list = copy.copy(test_list1)


def example_list_whole_slice():
   final_list = test_list1[:]
...
def main():
   ...
   func_dict = {
      ...
      'example_list_copy': (example_list_copy, [], {}),
      'example_list_copy_copy': (example_list_copy_copy, [], {}),
      'example_list_whole_slice': (example_list_whole_slice, [], {}),
   }
   ...
   check_run_sec = 1
   with open('result_output/Example19ListCopyVsListSlice.txt', 'w') as file_:
      file_.write('\n\n Example19ListCopyVsListSlice.py output\n\n')
