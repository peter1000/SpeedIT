...
def main():
   ...
   func_dict = {
      ...
      'example_list_init': (example_list_init, [], {}),
      'example_deque_init': (example_deque_init, [], {})
   }
   ...
   check_run_sec = 1
   with open('result_output/Example21InitListInitDeque.txt', 'w') as file_:
      file_.write('\n\n Example21InitListInitDeque.py output\n\n')
